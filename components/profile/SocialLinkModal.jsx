...
export default function SocialLinkModal({ link, platforms, onSave, onClose }) {
  ...
  useEffect(() => {
    if (link) {
      ...
      setSelectedPlatform(platform || platforms.find(p => p.id === 'other'));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedPlatform.id === 'website' || selectedPlatform.id === 'other') {
                ...
                <div className="grid grid-cols-4 gap-3">
                  {platforms.map((platform) => {
                    ...
                    return (
                      ...
                      >
                        <div className={`w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center ${platform.color}`}>
              ...
              {selectedPlatform && (
                <div className="space-y-3">
                  <Label className="text-gray-900 font-medium">
                    {(selectedPlatform.id === 'website' || selectedPlatform.id === 'other') ? 'URL completa' : `Usuario de ${selectedPlatform.name}`}
                  </Label>
                  
                  {(selectedPlatform.id === 'website' || selectedPlatform.id === 'other') ? (
                    <Input
                      type="url"
                      value={customUrl}
