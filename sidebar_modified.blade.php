...
<div class="navbar-nav">
    ...
    {{-- REFERIDOS (antes parte de Referral) --}}
    <div class="nav-item">
        <a class="nav-link {{ Request::routeIs('user.referrals.*') ? 'active' : '' }}" href="{{ route('user.referrals.index') }}">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
    ...
    {{-- SOLICITUDES DE RETIRO (antes parte de Referral) --}}
    <div class="nav-item">
        <a class="nav-link {{ Request::routeIs('user.withdrawals.*') ? 'active' : '' }}" href="{{ route('user.withdrawals.index') }}">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                    <path d="M17 8v-3a1 1 0 0 0 -1 -1h-10a2 2 0 0 0 0 4h12a1 1 0 0 1 1 1v3m0 4v3a1 1 0 0 1 -1 1h-12a2 2 0 0 1 -2 -2v-12" />
    ...
    {{-- GALERÍA (antes Media) --}}
    <div class="nav-item">
        <a class="nav-link {{ Request::routeIs('user.media.*') ? 'active' : '' }}" href="{{ route('user.media.index') }}">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
    ...
    {{-- PLANS --}}
    <div class="nav-item">
        <a class="nav-link {{ Request::routeIs('user.plans.*') ? 'active' : '' }}" href="{{ route('user.plans.index') }}">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
    ...
    <div class="nav-item">
        <a class="nav-link {{ Request::routeIs('user.account.*') ? 'active' : '' }}" href="{{ route('user.account.index') }}">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
{{-- ELEMENTOS OCULTOS/ELIMINADOS:
- Order NFC Card
- My Orders  
- My NFC Cards
- Transactions (NFC Card / Plan)
- Referral (como padre con hijos) - separado en Referidos y Solicitudes de retiro
--}}